...
class User(AbstractUser):
    ...
    mobile = models.CharField("手机号", max_length=30, null=True, blank=True)
...
class UserOpenid(models.Model):
    ...
    head_img = models.CharField('头像', max_length=200, null=True, blank=True)
...
class AddressUser(models.Model):
    '''用户地址表'''
    user = models.ForeignKey(User, verbose_name='用户地址')
